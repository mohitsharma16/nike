  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col
       justify-center items-start w-full max-xl:paddding-x pt-28'>
        ...
        <p className='font-montserrat text-slate-gray text-lg leading-8 mt-14 sm:max-w-sm'>Discover stylish Nike arrivals, quality comfort,
